# %% [markdown]
# ### RANDOM FOREST CLASSIFICATION USING SCIKIT-LEARN ON AGENTS DATASET 
...
path = '../complete_file_agents.csv'
df = pd.read_csv(path)

# Selecting features and target variable
X = df[['KD', 'Kills', 'Deaths', 'Assists', 'Pick Rate', 'ACS', 'First Blood', 'Num Matches']]
y = df['Label']
